...
def send_email_notification(chat_url):
    if ENABLE_EMAIL:
        ...
        email = Email(
            ...
            'A video doorbell caller is waiting on the virtual meeting room.  You can open the door at: http://192.168.1.6:5000/       Meet them at %s' % chat_url
        )
        email.send(TO_EMAIL)
